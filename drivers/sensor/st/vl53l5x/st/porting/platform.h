...
/* Forward declaration for callback typedefs. */
typedef struct VL53L5CX_Platform_t VL53L5CX_Platform;

typedef int32_t (*VL53L5CX_get_tick_Func)(void);
typedef int32_t (*VL53L5CX_write_Func)(VL53L5CX_Platform *, uint16_t, uint8_t *, uint16_t);
typedef int32_t (*VL53L5CX_read_Func)(VL53L5CX_Platform *, uint16_t, uint8_t *, uint16_t);
